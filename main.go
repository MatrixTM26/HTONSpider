...
func ShowBanner() {
	...
	fmt.Println()
	fmt.Println(`    M""MMMMM""MM M""""""""M MMP"""""YMM M"""""""'YM MP""""""'MM          oo       dP                  `)
    fmt.Println(`    M  MMMMM  MM Mmmm  mmmM M' .mmm. 'M M  mmmm.  M M  mmmmm..M                   88                  `)
    fmt.Println(`    M         'M MMMM  MMMM M  MMMMM  M M  MMMMM  M M.      'YM 88d888b. dP .d888b88 .d8888b. 88d888b.`)
    fmt.Println(`    M  MMMMM  MM MMMM  MMMM M  MMMMM  M M  MMMMM  M MMMMMMM.  M 88'  '88 88 88'  '88 88ooood8 88'  '88`)
    fmt.Println(`    M  MMMMM  MM MMMM  MMMM M. 'MMM' .M M  MMMMM  M M. .MMM'  M 88.  .88 88 88.  .88 88.  ... 88      `)
    fmt.Println(`    M  MMMMM  MM MMMM  MMMM MMb     dMM M  MMMMM  M Mb.     .dM 88Y888P' dP '88888P8 '88888P' dP      `)
    fmt.Println(`    MMMMMMMMMMMM MMMMMMMMMM MMMMMMMMMMM MMMMMMMMMMM MMMMMMMMMMM 88                                    `)
    fmt.Println(`                                                                dP                                    `)
